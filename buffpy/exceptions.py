...
class BuffpyRestException(BuffpyException):
    ...
    def __init__(self, url, http_code, error_code=None, description=None,
                 method='GET'):
        self.url = url
    ...
    def __str__(self):
        ...
        if hasattr(sys.stderr, 'isatty') and sys.stderr.isatty():
            msg = (
                ...
                "\n\nHTTP {http_code} error: {error_code} description: "
                "{description}\n".format(
            ...
            return "HTTP {} error: {} description: {}".format(
                self.http_code, self.error_code, self.description)
